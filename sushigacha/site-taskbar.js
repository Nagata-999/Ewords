...
(()=>{
  ...
  sheet.querySelector('.sdq-close').onclick=()=>sheet.classList.remove('open');sheet.addEventListener('click',e=>{if(e.target===sheet)sheet.classList.remove('open')});bar.querySelector('#sushiDailyTab').onclick=()=>{sheet.classList.add('open');render()};sheet.querySelector('#sdqChest').onclick=chest;
  ...
  if(!document.querySelector('script[src*="daily-quest-click-bridge.js"]')){const s=document.createElement('script');s.src='/sushigacha/daily-quest-click-bridge.js?v=20260914-5';document.head.appendChild(s)}
})();